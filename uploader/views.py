...
def create_image_uploader(request): 
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            zipped_data = zip(characters, predicted)

            return render(request, 'uploader/details.html', {'image_path': image_path, 'image_prop':image_prop, 'disable_button':False, 'zipped_data':zipped_data})
    context = {"form": form,}
